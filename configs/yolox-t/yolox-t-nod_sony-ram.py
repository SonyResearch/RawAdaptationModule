...
train_pipeline = [
    ...
    dict(
        type='RandomResize', scale=[(600, 320), (600, 400)],
        keep_ratio=True),
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/raw_new_Sony_RX100m7_train.json',
        data_prefix=dict(img='raw_new_Sony_RX100m7_train/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/raw_new_Sony_RX100m7_test.json',
        data_prefix=dict(img='raw_new_Sony_RX100m7_test/'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/raw_new_Sony_RX100m7_test.json',
    metric='bbox',

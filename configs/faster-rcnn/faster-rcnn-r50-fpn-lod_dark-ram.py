...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/all_dark-train.json',
        data_prefix=dict(img='RAW_proc/RAW_dark/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotations/all_dark-val.json',
        data_prefix=dict(img='RAW_proc/RAW_dark/'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/all_dark-val.json',
    metric='bbox',
